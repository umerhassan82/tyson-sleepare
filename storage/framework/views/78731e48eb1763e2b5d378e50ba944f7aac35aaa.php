                        ...
                        <div class="row">
                          ...
                          <div class="col col-4 totalPrices">
                              <div class="col-md-12 mt-4">
                                  <h4 class="mt-2">
                                      <b>Total:</b> 
                                      <span class="text-secondary">$</span><span class="text-secondary" id="total-cost"><?php echo e(number_format($total*config('rate'), 2), false); ?></span>
                                  </h4>
                              </div>
                              <div class="col-md-12">
                                  <h4 class="mt-2">
                              ...
                              <div class="col-md-12 pr-0">
                                  <h4 class="mt-2">
                                      <b>Tax:</b> 
                                      <span class="text-secondary">$</span><span class="text-secondary" id="cart-tax"><?php echo e(number_format($cart_tax, 2), false); ?></span>
                                  </h4>
                                  <input type="hidden" id="cart_tax" name="cart_tax" value="<?php echo e(round($cart_tax, 2), false); ?>" class="form-control">
                              </div>
                              <div class="col-md-12 mb-4 mt-3">
                                  <h4 class="mt-2">
                                      <b>Grand Total:</b> 
                                      $<span id="grand-total"><?php echo e(number_format($grand_total, 2), false); ?></span>
                                  </h4>
                              </div>
                          </div>
                      </div>
