        ...
        <tbody>
            <tr style="font-family:sans-serif">
                <td style="font-family:sans-serif;border-collapse:collapse;padding:30px" width="40%" bgcolor="#ffffff" align="center">
                    ...
                    <p style="margin-bottom: 0; font-size:10px;color:rgb(117,117,117);font-family:sans-serif">This email is confirming your order on {!! $date !!}</p>
                </td>
            </tr>
            <tr style="font-family:sans-serif">                            
                <td style="border-top:0px solid rgb(255,255,255); color:rgb(0,0,0);font-size:17px;line-height:34px;font-family:sans-serif;border-collapse:collapse;padding-top:20px; padding-bottom:30px;" bgcolor="#ffffff" align="left">
                    ...
                    <p style="margin-bottom:0px; font-family:sans-serif">Thank you for your order #{!! $orderID !!} , we will start working on it right away!</p>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="left" style="padding-bottom:20px; border-bottom: 2px solid #ccc; font-size: 13px; color: #333; font-weight: 500;">
                    <span style="width: 200px; display: inline-block;">Order#:</span> {!! $orderID !!}
                </td>
            </tr>
            {!! $orderItems !!}
            <tr style="font-family:sans-serif">
            ...
            <tr style="font-family:sans-serif">
                <td style="padding: 20px;" bgcolor="#ffffff" align="right">
                    <p style="margin-bottom:10px;font-family:sans-serif"><span style="font-size: 16px;">Shipping:</span> <span style="font-size: 15px; width: 150px; display: inline-block;">{!! $totalShippingCost !!} USD</span></p>
                    <p style="margin-bottom:10px;font-family:sans-serif"><span style="font-size: 16px;">Tax:</span> <span style="font-size: 15px; width: 150px; display: inline-block;">{!! $totalTax !!} USD</span></p>
                    <p style="font-family:sans-serif;margin:0px"><span style="font-size: 16px;">Total:</span> <span style="font-size: 15px; width: 150px; display: inline-block;">{!! $totalCost !!} USD</span></p>
                </td>
            </tr>
            <tr style="font-family:sans-serif">                            
                <td style="border-top:0px solid rgb(255,255,255); color:rgb(0,0,0);font-size:17px;line-height:34px;font-family:sans-serif;border-collapse:collapse;padding-top:20px; padding-bottom:30px;" bgcolor="#ffffff" align="left">
